...
split the data to train(<2010) and test( >2010)
create 2 models for aic and lasso with the features they provided.
Train the models with train data and test it.
Document everything*
