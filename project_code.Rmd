...
Further removing state name and district name because we have their codes.We can refer notes for district name if required.

```{r}
#df.all <- select(df.all,-4,-5)
#df.all<- select(df.all,-c("Year","Year.y"))
```
