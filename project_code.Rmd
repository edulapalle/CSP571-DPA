...
Our Linear regression model (model.all with all predictor) variables gave an Adjusted r-squared value of 0.9293.
...
We can see that our Linear Regression model with all predictors did not correctly predict the results, the predictions were too bad. And RMSE is around 3076.591
