...
Our fwdfit.aic model gave Adjusted R-squared values of 0.9765 with only 34 predictors which indicates a very good model compared to model.all
...
We can see both of our models predicted good results.
