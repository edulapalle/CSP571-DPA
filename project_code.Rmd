...
So this affects for future analysis, we will bring them to same range -1 to 1 by dividing each column with its maximum value.
...
But by taking averages of columns season-wise, and deleting repeated columns, we reduced predictors from 137 to 80 and 780 observations.
