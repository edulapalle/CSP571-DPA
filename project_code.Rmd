...
test7 <- full_join(test5,df.irrigation.sourcewise.irrigated.area, by= c("Dist.Code","State.Code","State.Name","Dist.Name","Year"))

test8 <- full_join(test7,df.irrigation.rice.area, by= c("Dist.Code","State.Code","State.Name","Dist.Name","Year"))
